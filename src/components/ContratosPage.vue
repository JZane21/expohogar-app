...
<a class="text-blue-400 hover:font-semibold hover:text-blue-800" href="https://docs.google.com/document/d/1jr_wlWRF3MtDzb8rCBY_plVACNt3MOAUccaTX8BVlIA/edit?usp=sharing" target="_blank" rel="noopener noreferrer">contrato inicio</a>
        ...
        <div class="border border-gray-300 p-4 rounded-lg contrato-contenedor">
            <h2 class="text-lg font-semibold mb-2">Contrato de Cierre de Proyecto para el Desarrollo del Sitio Web de EXPOHOGAR</h2>
            <pre class="contrato-texto">
                Contrato de Cierre de Proyecto para el Desarrollo del Sitio Web de EXPOHOGAR
...
.contrato-texto b, .contrato-texto strong {
  font-weight: bold;
}
</style>
